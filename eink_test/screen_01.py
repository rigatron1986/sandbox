...
class Epd2in13bv3(object):
    ...
    def form_image(self):
        ...
        black_draw.text((0, 85), "{}Mbps".format('{:5.2f}'.format(self.data['speed']['download'] / 1E6, 2)),
                        font=self.get_font(10))
        black_draw.text((80, 85), "{}Mbps".format('{:5.2f}'.format(self.data['speed']['upload'] / 1E6, 2)),
                        font=self.get_font(10))
        black_draw.text((150, 85), "{}ms".format('{:5.2f}'.format(self.data['speed']['ping'])),
                        font=self.get_font(10))
    ...
    def get_data(self):
        ...
        self.data = {
            'ip_addr': self.get_wifi_ip_address(),
